/*
COMENTÁRIOS:
    A soma dos elementos de cada linha, coluna e sub-matriz de uma solução válida é igual a 45
    A multiplicação dos elementos de cada linha, coluna e sub-matriz de uma solução válida é igual a 362880
*/
#include <iostream>
...
/*================================== Caso queira ler a entrada de um arquivo texto ============================*/
//    FILE *arquivo =fopen("teste.txt", "r");
//    assert(arquivo != NULL);
//    fscanf(arquivo, "%d", &n);
/*================================== Caso queira ler a entrada de um arquivo texto ============================*/
    scanf("%d", &n); //Descomentar aqui caso a leitura das entradas seja por arquivo
        ...
        while(n > 0)
        {
            for(i = 0; i < 9; i++)
            {
                for(j = 0; j < 9; j++)
                {
                   cin>>sudoku[i][j];// Caso a leitura seja  por aquivo ==> fscanf(arquivo, "%d", &sudoku[i][j]);
